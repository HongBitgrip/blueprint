Ext.define("com.coremedia.cms.editor.sdk.premular.fields.RichTextPropertyFieldContextMenu", function(RichTextPropertyFieldContextMenu) {/*package com.coremedia.cms.editor.sdk.premular.fields{
...
public class RichTextPropertyFieldContextMenu extends Menu{

    import com.coremedia.ui.data.ValueExpression;

    public static const xtype:String = "com.coremedia.cms.editor.sdk.config.richTextPropertyFieldContextMenu";
    ...
    public*/function RichTextPropertyFieldContextMenu$(config/*:RichTextPropertyFieldContextMenu = null*/){if(arguments.length<=0)config=null;
    var config_$1/*:ext.menu.Menu*/ =AS3.cast(Ext.menu.Menu,{});
    var defaults_$1/*:RichTextPropertyFieldContextMenu*/ =AS3.cast(RichTextPropertyFieldContextMenu,{});
    config = net.jangaroo.ext.Exml.apply(defaults_$1,config);
    config_$1.plain = true;
    var menuItem_35_5_$1/*:ext.menu.Item*/ =AS3.cast(Ext.menu.Item,{});
    menuItem_35_5_$1.itemId =net.jangaroo.ext.Exml.asString( RichTextPropertyFieldContextMenu.OPEN_IN_TAB_MENU_ITEM_ID);
    ...
    menuItem_40_5_$1.itemId =net.jangaroo.ext.Exml.asString( RichTextPropertyFieldContextMenu.OPEN_IN_BROWSER_TAB_MENU_ITEM_ID);
    ...
    menuItem_46_5_$1.itemId =net.jangaroo.ext.Exml.asString( com.coremedia.cms.editor.sdk.premular.fields.RichTextPropertyField.IMAGE_PROPERTIES_ITEM_ID);
...
============================================== Jangaroo part ==============================================*/
    return {
      ...
      alias: "widget.com.coremedia.cms.editor.sdk.config.richTextPropertyFieldContextMenu",
      constructor: RichTextPropertyFieldContextMenu$,
      super$3ZW5: function() {
