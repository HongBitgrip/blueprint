Ext.define("ext.util.events.MixedCollection_me_sortersEvent", function(MixedCollection_me_sortersEvent) {/*package ext.util.events {
...
public class MixedCollection_me_sortersEvent extends FlExtEvent {
  ...
  public static const __PARAMETER_SEQUENCE__:Array =*/function __PARAMETER_SEQUENCE__$static_(){MixedCollection_me_sortersEvent.__PARAMETER_SEQUENCE__=( ["me", "sorters", "eOpts"]);}/*;

  public*/ function MixedCollection_me_sortersEvent$(type/*:String*/, arguments/*:Array*/) {
    this.super$$WgT(type, arguments);
  }/*
...
============================================== Jangaroo part ==============================================*/
    return {
      ...
      constructor: MixedCollection_me_sortersEvent$,
      super$$WgT: function() {
