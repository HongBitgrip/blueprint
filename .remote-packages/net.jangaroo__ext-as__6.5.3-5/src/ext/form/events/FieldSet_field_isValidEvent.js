Ext.define("ext.form.events.FieldSet_field_isValidEvent", function(FieldSet_field_isValidEvent) {/*package ext.form.events {
...
public class FieldSet_field_isValidEvent extends FlExtEvent {
  ...
  public static const __PARAMETER_SEQUENCE__:Array =*/function __PARAMETER_SEQUENCE__$static_(){FieldSet_field_isValidEvent.__PARAMETER_SEQUENCE__=( ["source", "field", "isValid", "eOpts"]);}/*;

  public*/ function FieldSet_field_isValidEvent$(type/*:String*/, arguments/*:Array*/) {
    this.super$sQUi(type, arguments);
  }/*
...
============================================== Jangaroo part ==============================================*/
    return {
      ...
      constructor: FieldSet_field_isValidEvent$,
      super$sQUi: function() {
