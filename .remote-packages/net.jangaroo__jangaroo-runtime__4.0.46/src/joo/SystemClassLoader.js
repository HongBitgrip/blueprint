...
public class SystemClassLoader {
  ...
  public static const classDeclarationsByName : Object/*<String,JooClassDeclaration>* / =*/function classDeclarationsByName$static_(){SystemClassLoader.classDeclarationsByName=( {});}/*;
  ...
  public*/ function prepare(/*...params*/)/* : JooClassDeclaration*/ {var params=Array.prototype.slice.call(arguments);
    ...
    if (!SystemClassLoader.isRuntimeCompatible(runtimeApiVersion, compilerVersion)) {
      throw new AS3.Error("Runtime version " + joo.runtimeApiVersion + "/" + joo.compilerVersion +
  ...
  private static*/ function toVersionParts$static(version/*:String*/)/*:Array*//*int*/ {
    var parts/*:Array*/ = (version || "").split(/\.|-preview/);
    for (var i/*:uint*/ = 0; i < parts.length; ++i) {
      parts[i] = parseInt(parts[i], 10);
      if (parts[i] < 0) {
        parts[i] = AS3.int_.MIN_VALUE - parts[i];
      }
    }
    return parts;
  }/*
   ...
   * /
  internal static*/ function isRuntimeCompatible$static(runtimeApiVersion/*:String*/, compilerVersion/*:String*/)/*:Boolean*/ {
    ...
    var runtimeCompilerVersionParts/*:Array*//*.<uint>*/ = toVersionParts$static(joo.compilerVersion);
    var compilerVersionParts/*:Array*//*.<uint>*/ = toVersionParts$static(compilerVersion);
  ...
  internal static*/ function addToMetadata$static(metadata/*:Object*/, annotation/*:**/)/*:void*/ {
  ...
  protected*/ function createClassDeclaration(packageDef/*:String*/, metadata/*:Object*/, classDef/*:String*/, inheritanceLevel/*:int*/, memberFactory/*:Function*/, publicStaticMethodNames/*:Array*/, dependencies/*:Array*/)/* : JooClassDeclaration*/ {
    return AS3.cast(joo.JooClassDeclaration,new joo.JooClassDeclaration(packageDef, metadata, classDef, inheritanceLevel, memberFactory, publicStaticMethodNames, dependencies).init());
  }/*

  public*/ function getClassDeclaration(fullClassName/* : String*/)/* : NativeClassDeclaration*/ {
    var cd/* : NativeClassDeclaration*/ = SystemClassLoader.classDeclarationsByName[fullClassName];
    if (!cd) {
  ...
  public*/ function getRequiredClassDeclaration(className/* : String*/)/* : NativeClassDeclaration*/ {
    ...
    if (!cd) {
      throw new AS3.Error("Class not found: "+className);
    }
    return cd;
  }/*
  ...
  public*/ function init(/*... classes*/)/* :Function*/ {var classes=Array.prototype.slice.call(arguments);
    return null;
  }/*
}
}
