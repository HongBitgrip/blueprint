Ext.define("net.jangaroo.net.URIImpl", function(URIImpl) {/*package net.jangaroo.net {
...
internal class URIImpl implements URI {
  ...
  public*/ function URIImpl$(scheme/*:String*/, authority/*:String*/, path/*:String*/, query/*:String*/, fragment/*:String*/) {
    AS3.assert(path !== null, "URIImpl.as", 41, 5);
    this.scheme = scheme;
  ...
  public*/ function toString()/*:String*/ {
    ...
    appendIfBothNonNull$static(this.scheme, ":", toAppendTo);
    appendIfBothNonNull$static("//", this.authority, toAppendTo);
    toAppendTo.push(this.path);
    appendIfBothNonNull$static("?", this.query, toAppendTo);
    appendIfBothNonNull$static("#", this.fragment, toAppendTo);
    return toAppendTo.join("");
  }/*

  private static*/ function appendIfBothNonNull$static(s1/*:String*/, s2/*:String*/, toAppendTo/*:Array*/)/*:void*/ {
    if (s1 !== null && s2 !== null) {
      toAppendTo.push(s1);
      toAppendTo.push(s2);
    }
  ...
  public*/ function relativize(reference/*:URI*/)/*:URI*/ {
    ...
    if (this.authority === targetAuthority) {
      ...
      if (!targetPath)
        targetPath = "";
      if (this.path !== null) {
        var lastSlash/*:int*/ = this.path.lastIndexOf('/');
        if (lastSlash >= 0) {
          var baseSegments/*:Array*/ = normalizedPathSegments$static(this.path);
          var targetPathSegments/*:Array*/ = normalizedPathSegments$static(targetPath);/*

          const*/var equalPaths/*:Boolean*/ = arraysEquals$static(baseSegments, targetPathSegments);
          ...
          if (equalPaths &&
            ...
            if (equalPaths) {
              ...
              targetPath = relativizePath$static(baseSegments, targetPathSegments);
            }
          }
        }
      }
  ...
  private static*/ function arraysEquals$static(a1/*:Array*/, a2/*:Array*/)/*:Boolean*/ {
  ...
  private static*/ function relativizePath$static(baseSegments/*:Array*/, pathSegments/*:Array*/)/*:String*/ {
    // find common root node:
    AS3.assert(pathSegments.length > 0, "URIImpl.as", 154, 5);
    AS3.assert(baseSegments.length > 0, "URIImpl.as", 155, 5);
    var i/*:int*/ = 0;
    ...
    while (i < pathSegments.length) {/*
      const*/var arc/*:String*/ = pathSegments[i];
  ...
  private static*/ function normalizedPathSegments$static(path/*:String*/)/*:Array*/ {
    return pathSegments$static(removeDotSegments$static(path));
  }/*

  private static*/ function pathSegments$static(path/*:String*/)/*:Array*/ {
    return path.split("/");
  }/*
  ...
  public*/ function resolve(reference/*:URI*/)/*:URI*/ {
    ...
    if (targetScheme !== null) {
      targetPath = removeDotSegments$static(targetPath);
    } else {
      if (targetAuthority !== null) {
        ...
        if (targetPath === null || targetPath === "") {
          ...
          targetPath = mergeAndRemoveDotSegments$static(this.authority, this.path, targetPath);
        }
  ...
  private static*/ function removeDotSegments$static(path/*:String*/)/*:String*/ {
    return path == null ? null : mergeAndRemoveDotSegments$static(null, "", path);
  }/*

  private static*/ function mergeAndRemoveDotSegments$static(baseAuthority/*:String*/, basePath/*:String*/, relPath/*:String*/)/*:String*/ {
    var resultPath/*:Array*/ = [ ];
    var relSegments/*:Array*/ = pathSegments$static(relPath);
    ...
    if (relPath.length == 0 || relPath.charAt(0) !== '/') {
      if (basePath == null || basePath.length == 0) {
        ...
        var baseSegments/*:Array*/ = pathSegments$static(basePath);
        baseSegments.forEach(function(segment/*:String*/)/*:void*/ {
          if (segment === "..") {
            popSegment$static(resultPath);
  ...
  private static*/ function popSegment$static(segments/*:Array*/)/*:void*/ {
...
============================================== Jangaroo part ==============================================*/
    return {
      mixins: ["net.jangaroo.net.URI"],
      constructor: URIImpl$,
      toString: toString,
      relativize: relativize,
      resolve: resolve,
      requires: ["net.jangaroo.net.URI"]
    };
});
