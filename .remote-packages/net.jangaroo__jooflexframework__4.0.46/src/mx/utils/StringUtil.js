Ext.define("mx.utils.StringUtil", function(StringUtil) {/* ////////////////////////////////////////////////////////////////////////////////
//
...
;/*
     ...
     *  beginning and end. 
     * /
    public static*/ function trim$static(str/*:String*/)/*:String*/
    {
        if (str == null) return '';
     ...
     * /
    public static*/ function trimArrayElements$static(value/*:String*/, delimiter/*:String*/)/*:String*/
    {
        if (value != "" && value != null)
        {
     ...
     *  a single space, tab, carriage return, newline, or formfeed character.
     * /
    public static*/ function isWhitespace$static(character/*:String*/)/*:Boolean*/
    {
        switch (character)
        {
            case " ":
     ...
     * /
    public static*/ function substitute$static(str/*:String, ... rest*/)/*:String*/
    {var rest=Array.prototype.slice.call(arguments,1);
        ...
        var args/*:Array*/;
        if (len == 1 &&AS3.is( rest[0],  Array))
        {
            args =AS3.as( rest[0],  Array);
            len = args.length;
        }
        else
        {
...
============================================== Jangaroo part ==============================================*/
    return {
      ...
      statics: {
        VERSION: "3.3.0.4852",
        trim: trim$static,
        trimArrayElements: trimArrayElements$static,
        isWhitespace: isWhitespace$static,
        substitute: substitute$static
      }
    };
});
