Ext.define("mx.utils.ObjectUtil", function(ObjectUtil) {/* ////////////////////////////////////////////////////////////////////////////////
//
...
;/*
    ...
    * /
    private static*/ var defaultToStringExcludes$static/*:Array*/;/* =*/function defaultToStringExcludes$static_(){defaultToStringExcludes$static=( ["password", "credentials"]);};/*
     ...
     * /
    public static*/ function compare$static(a/*:Object*/, b/*:Object*/, depth/*:int = -1*/)/*:int*/
    {if(arguments.length<=2)depth=-1;
        return internalCompare$static(a, b, 0, depth, new flash.utils.Dictionary(true));
    }/*
     ...
     * / 
    public static*/ function copy$static(value/*:Object*/)/*:Object*/
    {
...
//        return result;
     ...
     * /
    public static*/ function isSimple$static(value/*:Object*/)/*:Boolean*/
    {
        ...
        switch (type)
        {
            ...
            case "object":
            {
                return (AS3.is(value,  Date)) || (AS3.is(value,  Array));
            }
        }
     ...
     * /
    public static*/ function numericCompare$static(a/*:Number*/, b/*:Number*/)/*:int*/
    {
        if (isNaN(a) && isNaN(b))
            return 0;
     ...
     * /
    public static*/ function stringCompare$static(a/*:String*/, b/*:String*/,
                                         caseInsensitive/*:Boolean = false*/)/*:int*/
    {if(arguments.length<=2)caseInsensitive=false;
        if (a == null && b == null)
            return 0;
     ...
     * /
    public static*/ function dateCompare$static(a/*:Date*/, b/*:Date*/)/*:int*/
    {
        if (a == null && b == null)
            return 0;
     ...
     * </pre>
     * /
    public static*/ function toString$static(value/*:Object*/, 
                                    namespaceURIs/*:Array = null*/, 
                                    exclude/*:Array = null*/)/*:String*/
    {switch(Math.max(arguments.length,1)){case 1:namespaceURIs=null;case 2:exclude=null;}
        if (exclude == null)
        {
            exclude = defaultToStringExcludes$static;
        }
        
        refCount$static = 0;
        return internalToString$static(value, 0, null, namespaceURIs, exclude);
    }/*
     ...
     *  @private
     * /
    private static*/ function internalToString$static(value/*:Object*/, 
                                             indent/*:int = 0*/,
                                             refs/*:Dictionary= null*/, 
                                             namespaceURIs/*:Array = null*/, 
                                             exclude/*:Array = null*/)/*:String*/
    {switch(Math.max(arguments.length,1)){case 1:indent=0;case 2:refs=null;case 3:namespaceURIs=null;case 4:exclude=null;}
        var str/*:String*/;
...
//                }
                ...
                else
                {
                    ...
                    {
                        str += "#" + refCount$static;
                        refs[value] = refCount$static;
                        refCount$static++;
                    }

                    var isArray/*:Boolean*/ =AS3.is( value,  Array);
                    var isDict/*:Boolean*/ =AS3.is( value,  flash.utils.Dictionary);
                    var prop/*:**/;
                    indent += 2;
                    ...
                    for (var j/*:int*/ = 0; j < properties.length; j++)
                    {
                        ...
                        if (isDict)
                        {
                            ...
                            str += internalToString$static(prop, indent, refs,
                        ...
                        {
                            // print the value
                            str += internalToString$static(value[prop], indent, refs,
                                                    namespaceURIs, exclude);
                        }
     ...
     *  to the given string.
     * /
    private static*/ function newline$static(str/*:String*/, n/*:int = 0*/)/*:String*/
    ...
    private static*/ function internalCompare$static(a/*:Object*/, b/*:Object*/,
...
//            b = ObjectProxy(b).object_proxy::object;
        ...
        if (typeOfA == typeOfB)
        {
            switch(typeOfA)
            {
                ...
                case "number":
                {
                    result = ObjectUtil.numericCompare(AS3.as(a,  Number),AS3.as( b,  Number));
                    break;
                }
                
                case "string":
                {
                    result = ObjectUtil.stringCompare(AS3.as(a,  String),AS3.as( b,  String));
                    break;
                }
                ...
                case "object":
                {
                    ...
                    else if ((AS3.is(a,  Array)) && (AS3.is(b,  Array)))
                    {
                        result = arrayCompare$static(AS3.as(a,  Array),AS3.as( b,  Array), currentDepth, desiredDepth, refs);
                    }
                    else if ((AS3.is(a,  Date)) && (AS3.is(b,  Date)))
                    {
                        result = ObjectUtil.dateCompare(AS3.as(a,  Date),AS3.as( b,  Date));
                    }
                    else if ((AS3.is(a,  mx.collections.IList)) && (AS3.is(b,  mx.collections.IList)))
                    {
                        result = listCompare$static(AS3.as(a,  mx.collections.IList),AS3.as( b,  mx.collections.IList), currentDepth, desiredDepth, refs);
                    }
...
//                    }
                    else if (flash.utils.getQualifiedClassName(a) == flash.utils.getQualifiedClassName(b))
                    {
                        ...
                        if (flash.utils.getQualifiedClassName(a) == "Object")
                        {
                            ...
                            result = arrayCompare$static(aProps, bProps, currentDepth, newDepth, refs);
                        }
                        ...
                        for (var i/*:int*/ = 0; i < aProps.length; i++)
                        {
                            ...
                            aProp = a[propName];
                            bProp = b[propName];
                            result = internalCompare$static(aProp, bProp, currentDepth+1, newDepth, refs);
                            if (result != 0)
                            {
                                i = aProps.length;
                            }
     ...
     *  </ul>
    * /
    public static*/ function getClassInfo$static(obj/*:Object*/,
                                        excludes/*:Array = null*/,
                                        options/*:Object = null*/)/*:Object*/
    {switch(Math.max(arguments.length,1)){case 1:excludes=null;case 2:options=null;}
//        var n:int;
//        var i:int;
//
...
//        return result;
     ...
     * /
    public static*/ function hasMetadata$static(obj/*:Object*/, 
                propName/*:String*/, 
                metadataName/*:String*/, 
                excludes/*:Array = null*/,
                options/*:Object = null*/)/*:Boolean*/
    {switch(Math.max(arguments.length,3)){case 3:excludes=null;case 4:options=null;}
        var classInfo/*:Object*/ = ObjectUtil.getClassInfo(obj, excludes, options);
        var metadataInfo/*:Object*/ = classInfo["metadata"];
        return internalHasMetadata$static(metadataInfo, propName, metadataName);
    }/*

    /**
     *  @private
     * /
    private static*/ function internalHasMetadata$static(metadataInfo/*:Object*/, propName/*:String*/, metadataName/*:String*/)/*:Boolean*/
    {
...
//    }
     ...
     *  @private
     * /
    private static*/ function getCacheKey$static(o/*:Object*/, excludes/*:Array = null*/, options/*:Object = null*/)/*:String*/
    {switch(Math.max(arguments.length,1)){case 1:excludes=null;case 2:options=null;}
        ...
        if (excludes != null)
        {
            ...
            {
                var excl/*:String*/ =AS3.as( excludes[i],  String);
                if (excl != null)
                    key += excl;
            }
        }
        ...
        if (options != null)
        {
            ...
            {
                key += flag;
                var value/*:String*/ =AS3.as( options[flag],  String);
                if (value != null)
                    key += value;
            }
        }
     ...
     *  @private
     * /
    private static*/ function arrayCompare$static(a/*:Array*/, b/*:Array*/,
                                         currentDepth/*:int*/, desiredDepth/*:int*/,
                                         refs/*:Dictionary*/)/*:int*/
    {
        var result/*:int*/ = 0;
        ...
        {
            var key/*:String*/;
            for (var $1=0;$1</* in*/ a.length;++$1)
            {key=String($1);
                if (b.hasOwnProperty(key))
                {
                    result = internalCompare$static(a[key], b[key], currentDepth,
                                         desiredDepth, refs);
...
//    }
     ...
     *  @private
     * /
    private static*/ function listCompare$static(a/*:IList*/, b/*:IList*/, currentDepth/*:int*/, 
                                        desiredDepth/*:int*/, refs/*:Dictionary*/)/*:int*/
    {
        ...
        else
        {
            for (var i/*:int*/ = 0; i < a.length; i++)
            {
                result = internalCompare$static(a.getItemAt(i), b.getItemAt(i), 
     ...
     * @private
     * /
    private static*/ var refCount$static/*:int*/ = 0;/*

    /**
     * @private
     * / 
    private static*/ var CLASS_INFO_CACHE$static/*:Object*/;/* =*/function CLASS_INFO_CACHE$static_(){CLASS_INFO_CACHE$static=( {});};/*
}*/function ObjectUtil$() {}/*
...
============================================== Jangaroo part ==============================================*/
    return {
      constructor: ObjectUtil$,
      statics: {
        VERSION: "3.3.0.4852",
        defaultToStringExcludes: undefined,
        compare: compare$static,
        copy: copy$static,
        isSimple: isSimple$static,
        numericCompare: numericCompare$static,
        stringCompare: stringCompare$static,
        dateCompare: dateCompare$static,
        toString: toString$static,
        getClassInfo: getClassInfo$static,
        hasMetadata: hasMetadata$static,
        CLASS_INFO_CACHE: undefined,
        __initStatics__: function() {
          defaultToStringExcludes$static_();
          CLASS_INFO_CACHE$static_();
        }
      },
      requires: [
        "AS3.Error",
