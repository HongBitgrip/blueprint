Ext.define("mx.events.CollectionEvent", function(CollectionEvent) {/* ////////////////////////////////////////////////////////////////////////////////
//
...
;/*
    ...
    {switch(Math.max(arguments.length,1)){case 1:bubbles=false;case 2:cancelable=false;case 3:kind=null;case 4:location=-1;case 5:oldLocation=-1;case 6:items=null;}
        this.super$WhTA(type, bubbles, cancelable);
