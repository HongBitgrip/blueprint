Ext.define("flash.utils.describeType", function(describeType) {/*package flash.utils {
...
public*/ function describeType(value/*:**/)/*:XML*/ {
  ...
  if (type && type.prototype) {
    ...
    for/* each*/ (var $1=0;$1</* in*/ propertyNames.length;++$1) {var p/*:String*/ =propertyNames[$1];
      if (p.match(/^[a-zA-Z_]/)) {
