Ext.define("flash.utils.Timer", function(Timer) {/*package flash.utils {
...
public class Timer extends EventDispatcher {
   ...
   * </listing>
   * /
  public*/ function Timer$(delay/*:Number*/, repeatCount/*:int = 0*/) {this.super$lKgg();if(arguments.length<=1)repeatCount=0;
  ...
  public*/ function start()/*:void*/ {
    if (!this.timer$lKgg) {
      this.timer$lKgg = flash.utils.setInterval(AS3.bind(this,"tick$lKgg"), this._delay$lKgg);
    }
  }/*
  ...
  private*/ function checkComplete()/*:void*/ {
    if (this._repeatCount$lKgg > 0 && this._currentCount$lKgg >= this._repeatCount$lKgg) {
      this.stop();
