Ext.define("flash.utils.setInterval", function(setInterval) {/*package flash.utils {
 ...
 * </listing>
 * /
public*/ function setInterval(closure/*:Function*/, delay/*:Number, ...rest*/)/*:uint*/ {var rest=Array.prototype.slice.call(arguments,2);
  var timeout/*:**/ = window.setInterval(flash.utils.applyWithRestParameters(closure, rest), delay);
  return timeout;
}/*
}
