Ext.define("flash.utils.setTimeout", function(setTimeout) {/*package flash.utils {
 ...
 * </listing>
 * /
public*/ function setTimeout(closure/*:Function*/, delay/*:Number, ...rest*/)/*:uint*/ {var rest=Array.prototype.slice.call(arguments,2);
  var timeout/*:**/ = window.setTimeout(flash.utils.applyWithRestParameters(closure, rest), delay);
  return timeout;
}/*
}
