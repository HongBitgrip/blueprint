Ext.define("flash.events.EventDispatcher", function(EventDispatcher) {/*package flash.events {
...
public class EventDispatcher implements IEventDispatcher {
   ...
   *
   * /
  public*/ function EventDispatcher$(target/*:IEventDispatcher = null*/) {captureListeners_.call(this);listeners_.call(this);if(arguments.length<=0)target=null;
  ...
  public*/ function addEventListener(type/*:String*/, listener/*:Function*/, useCapture/*:Boolean = false*/, priority/*:int = 0*/, useWeakReference/*:Boolean = false*/)/*:void*/ {switch(Math.max(arguments.length,2)){case 2:useCapture=false;case 3:priority=0;case 4:useWeakReference=false;}
    var listenersByType/*:Object*/ = useCapture ? this.captureListeners$bq6g : this.listeners$bq6g;
  ...
  public*/ function dispatchEvent(event/*:Event*/)/*:Boolean*/ {
    ...
    var ancestors/*:Array*/ = this.createAncestorChain();
    ...
    if (!event.isPropagationStopped()) {
      ...
      var listeners/*:Array*/ = this.listeners$bq6g[event.type];
      if (listeners) {
        processListeners$static(event, listeners);
      }
    }
  ...
  public*/ function toString()/*:String*/ {
    return ["EventDispatcher[target=", this.target$bq6g, "]"].join("");
  }/*
  ...
  public*/ function processCapture(event/*:Event*/)/*:void*/ {
    ...
    var listeners/*:Array*/ = this.captureListeners$bq6g[event.type];
    if (listeners) {
      processListeners$static(event, listeners);
    }
  }/*
  ...
  private static*/ function eventCompare$static(item1/*:Object*/, item2/*:Object*/)/*:int*/ {
  ...
  private static*/ function internalHandleCapture$static(event/*:Event*/, ancestors/*:Array*/)/*:void*/ {
  ...
  private static*/ function internalHandleBubble$static(event/*:Event*/, ancestors/*:Array*/)/*:void*/ {
    if (!ancestors || ancestors.length <= 0) {
      return;
    }
  ...
  private static*/ function processListeners$static(event/*:Event*/, listeners/*:Array*/)/*:void*/ {
    for (var i/*:int*/ = 0; i < listeners.length; ++i) {
  ...
  private var captureListeners:Object =*/function captureListeners_(){this.captureListeners$bq6g=( {});}/*; /*<String,Array>* /
  private var listeners:Object =*/function listeners_(){this.listeners$bq6g=( {});}/*; /*<String,Array>* /
