Ext.define("flash.events.TimerEvent", function(TimerEvent) {/*package flash.events {
/**
...
public class TimerEvent extends Event {
   ...
   *
   * /
  public*/ function TimerEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/) {switch(Math.max(arguments.length,1)){case 1:bubbles=false;case 2:cancelable=false;}
